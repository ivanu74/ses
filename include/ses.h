...
#define MAX_COUNT_PER_ELEMENT  110
...
#define PAGE_ZERO  0x0
#define PAGE_ONE   0x1
#define PAGE_TWO   0x2
#define PAGE_FIVE  0x5
#define PAGE_SEVEN 0x7
#define PAGE_A     0xa
...
/* validate additional element with eip == 1 and protocol == PCIe */
extern void verify_additional_element_eip_pcie (
  unsigned char *additional_element);
